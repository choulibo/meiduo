...
SECRET_KEY = 'a+z(dopjs^12k$zdeclrym3po)h8xz!j6)_t^c_#$j59k+o5f-'
...
CORS_ALLOW_CREDENTIALS = True  # 允许携带cook
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = '18103849049@163.com'
# 在邮箱中设置的客户端授权密码
